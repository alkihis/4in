...
function adminView(Controller $c) : void {
    ...
    <ul id="slide-out-admin" class="sidenav sidenav-fixed">
        ...
        ><a class="waves-effect" href="/admin/build/genome"><i class="material-icons">storage</i>Build genome database</a></li>
        <li <?= ($d['active_page'] === 'build_blast' ? 'class="active"' : '') ?>
        ><a class="waves-effect" href="/admin/build/blast"><i class="material-icons">sort</i>Build BLAST database</a></li>

        <li><div class="divider"></div></li>

        <li><a class="subheader">Import</a></li>
        <li <?= ($d['active_page'] === 'import_genome' ? 'class="active"' : '') ?>
        ><a class="waves-effect" href="/admin/import/genome"><i class="material-icons">backup</i>Import genome file</a></li>
        <li <?= ($d['active_page'] === 'import_blast' ? 'class="active"' : '') ?>
        ><a class="waves-effect" href="/admin/import/blast"><i class="material-icons">playlist_add</i>Import sequence files</a></li>

        <li><div class="divider"></div></li>

        <li><a class="subheader">Mapping</a></li>
        <li <?= ($d['active_page'] === 'alias_import' ? 'class="active"' : '') ?>
        ><a class="waves-effect" href="/admin/alias/import"><i class="material-icons">import_export</i>Import mapping files</a></li>
        <li <?= ($d['active_page'] === 'alias_build' ? 'class="active"' : '') ?>
        ><a class="waves-effect" href="/admin/alias/build"><i class="material-icons">merge_type</i>Construct alias mapping</a></li>

        <li><div class="divider"></div></li>

        <li><a class="subheader">Manage</a></li>
        <li <?= ($d['active_page'] === 'reset' ? 'class="active"' : '') ?>
        ><a class="waves-effect" href="/admin/reset_link"><i class="material-icons">refresh</i>Reset link status</a></li>
        <li <?= ($d['active_page'] === 'species' ? 'class="active"' : '') ?>
        ><a class="waves-effect" href="/admin/species"><i class="material-icons">lock</i>Protected species</a></li>
        <li <?= ($d['active_page'] === 'password' ? 'class="active"' : '') ?>
        ><a class="waves-effect" href="/admin/password"><i class="material-icons">vpn_key</i>Change password</a></li>
    </ul>
